...
const jsonDocstrings = fs.readFileSync(
  path.join(PYTHON_DIRECTORY, "javelit.json"),
  "utf8",
);

// TODO CYRIL - snowflake here is deprecated - see https://github.com/streamlit/docs/pull/1258
const jsonPlatformNotes = fs.readFileSync(
  path.join(PYTHON_DIRECTORY, "snow_deprecated.json"),
  "utf8",
);
