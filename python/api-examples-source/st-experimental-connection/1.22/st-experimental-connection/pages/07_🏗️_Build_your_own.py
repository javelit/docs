...
"""
You can build your own Connection by extending the [built-in ExperimentalBaseConnection.](https://docs.jeamlit.io/develop/api-reference/connections/st.connections.experimentalbaseconnection)
