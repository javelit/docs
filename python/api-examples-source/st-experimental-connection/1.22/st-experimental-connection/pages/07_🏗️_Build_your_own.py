...
"""
You can build your own Connection by extending the [built-in ExperimentalBaseConnection.](https://docs.javelit.io/develop/api-reference/connections/st.connections.experimentalbaseconnection)
