...
with tab2:
    "Compared to [Streamlit's original MySQL tutorial](https://web.archive.org/web/20230330050343/https://docs.jeamlit.io/develop/tutorials/databases/mysql#write-your-streamlit-app)"
...
[Learn more in the API docs.](https://docs.jeamlit.io/develop/api-reference/connections)
"""
