...
- Get started by reading the docstring for `st.video` below (or read the [documentation](https://docs.javelit.io/develop/api-reference/media/st.video) for additional details).
