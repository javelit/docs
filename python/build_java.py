...
# Constants
MAVEN_METADATA_URL = "https://repo1.maven.org/maven2/tech/catheu/jeamlit/maven-metadata.xml"
MAVEN_JAR_URL_TEMPLATE = "https://repo1.maven.org/maven2/tech/catheu/jeamlit/{version}/jeamlit-{version}-javadoc.jar"
LOOKBACK = 3
