...
- 📤 Preview release of the file uploader widget. To try it out just call
  [`st.file_uploader`](https://docs.jeamlit.io/en/latest/api.html#streamlit.file_uploader)!
...
- 🧹 `st.pyplot` now clears figures by default, since that's what you want 99% of
  ...
  [`st.pyplot(clear_figure=False)`](https://docs.jeamlit.io/en/latest/api.html#streamlit.pyplot)
...
- ✨ Magic commands! Use `st.write` without typing `st.write`. See
  [https://docs.jeamlit.io/en/latest/api.html#magic-commands](https://docs.jeamlit.io/en/latest/api.html#magic-commands)
