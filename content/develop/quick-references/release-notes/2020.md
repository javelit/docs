...
- 🐙 Fix Streamlit sharing deploy experience for users running on Git versions
  2.7.0 or earlier.
- 🧰 Handle unexpected closing of uploaded files for [`st.file_uploader`](https://docs.jeamlit.io/en/0.72.0/api.html#streamlit.file_uploader).
...
- 🧰 Update [`st.file_uploader`](https://docs.jeamlit.io/en/0.71.0/api.html#streamlit.file_uploader) to reduce reruns.
...
- 📁 Updated [`st.file_uploader`](https://docs.jeamlit.io/en/0.71.0/api.html#streamlit.file_uploader)
...
- 🧪 [`st.set_page_config`](https://docs.jeamlit.io/en/0.70.0/api.html#streamlit.set_page_config) and [`st.color_picker`](https://docs.jeamlit.io/en/0.70.0/api.html#streamlit.color_picker) have now been moved into the
  Streamlit namespace. These will be removed from beta January 28th, 2021. Learn
  more about our beta process [here](https://docs.jeamlit.io/en/0.70.0/api.html#beta-and-experimental-features).
...
- 💾 File uploader redesigned with new functionality for multiple files uploads
  ...
  [documentation](https://docs.jeamlit.io/en/0.68.0/api.html#streamlit.file_uploader)
...
- ⚙️ Ability to set page title, favicon, sidebar state, and wide mode via st.beta_set_page_config(). See our [documentation](https://docs.jeamlit.io/en/0.65.0/api.html#streamlit.set_page_config) for details.
...
- 🧩 **Support for Streamlit Components!!!** See
  [documentation](https://docs.jeamlit.io/en/latest/streamlit_components.html) for more info.
- 🕗 Support for datetimes in
  [`st.slider`](https://docs.jeamlit.io/en/latest/api.html#streamlit.slider). And, of course, just
...
- 📅 Support for date ranges in `st.date_picker`. See
  [docs](https://docs.jeamlit.io/en/latest/api.html#streamlit.date_picker)
...
- 🗣️ You can now choose whether `st.echo` prints the code above or below the output of the echoed
  ...
  [docs](https://docs.jeamlit.io/en/latest/api.html#streamlit.echo).
...
- ↕️ Ability to set the height of an `st.text_area` with the `height` argument
  ...
  [docs](https://docs.jeamlit.io/en/latest/api.html#streamlit.text_area) for more.
- 🔡 Ability to set the maximimum number of characters allowed in `st.text_area`
  ...
  [docs](https://docs.jeamlit.io/en/latest/api.html#streamlit.text_area).
- 🗺️ Better DeckGL support for the [H3](https://h3geo.org/) geospatial indexing
  ...
  [`st.pydeck_chart`](https://docs.jeamlit.io/en/latest/api.html#streamlit.pydeck_chart).
...
- 🎨 New color-picker widget! Use it with
  [`st.beta_color_picker()`](https://docs.jeamlit.io/en/0.69.0/api.html#streamlit.beta_color_picker)
- 🧪 Introducing `st.beta_*` and `st.experimental_*` function prefixes, for faster
  Streamlit feature releases. See
  [docs](https://docs.jeamlit.io/en/latest/api.html#pre-release-features) for more info.
...
- ⏲️ Ability to set expiration options for `@st.cache`'ed functions by setting
  ...
  [docs](https://docs.jeamlit.io/en/latest/api.html#streamlit.cache).
...
- 🗺️ Support for all DeckGL features! Just use
  ...
  [`st.deck_gl_chart`](https://docs.jeamlit.io/en/latest/api.html#streamlit.pydeck_chart).
  To do that, simply pass a PyDeck object to
  [`st.pydeck_chart`](https://docs.jeamlit.io/en/latest/api.html#streamlit.pydeck_chart),
  [`st.write`](https://docs.jeamlit.io/en/latest/api.html#streamlit.write),
  or [magic](https://docs.jeamlit.io/en/latest/api.html#magic).
