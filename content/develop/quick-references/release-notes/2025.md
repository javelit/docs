...
- 🧭 Introducing top navigation! Use [`st.navigation`](https://docs.jeamlit.io/develop/api-reference/navigation/st.navigation) with `position="top"` to create a navigation menu across the top of your app.
- 🔆 You can detect if the viewer is in light mode or dark mode at runtime with [`st.context.theme`](https://docs.jeamlit.io/develop/api-reference/caching-and-state/st.context#contexttheme).
...
- ⬆️ [`st.form`](https://docs.jeamlit.io/develop/api-reference/execution-flow/st.form) has a new parameter to configure its `height`.
- 🛠️ [`st.columns`](https://docs.jeamlit.io/develop/api-reference/layout/st.columns) supports `gap=None` for no gap between columns.
- 🏋️ Font face declarations in [`config.toml`](https://docs.jeamlit.io/develop/api-reference/configuration/config.toml#theme) support weight and unicode ranges ([#11248](https://github.com/streamlit/streamlit/pull/11248), [#11163](https://github.com/streamlit/streamlit/issues/11163), [#11247](https://github.com/streamlit/streamlit/issues/11247)).
...
- 🧑 Announcing the general availability of [`st.user`](https://docs.jeamlit.io/develop/api-reference/user/st.user), a dict-like object to access information about the current user.

**Notable Changes**

- ➕ [`st.multiselect`](https://docs.jeamlit.io/develop/api-reference/widgets/st.multiselect) and [`st.selectbox`](https://docs.jeamlit.io/develop/api-reference/widgets/st.selectbox) have a new parameter to let users add new options.
- 🥸 [`st.context`](https://docs.jeamlit.io/develop/api-reference/caching-and-state/st.context) has new attributes: `url`, `ip_address`, and `is_embedded`.
- ⚠️ Text [alerts](https://docs.jeamlit.io/develop/api-reference/status/st.success) and [exceptions](https://docs.jeamlit.io/develop/api-reference/status/st.exception) have a new `width` parameter ([#11142](https://github.com/streamlit/streamlit/pull/11142)).
- ⌨️ You can set the tab index for [`st.components.v1.html`](https://docs.jeamlit.io/develop/api-reference/custom-components/st.components.v1.html) and [`st.components.v1.iframe`](https://docs.jeamlit.io/develop/api-reference/custom-components/st.components.v1.iframe) ([#11065](https://github.com/streamlit/streamlit/pull/11065), [#7969](https://github.com/streamlit/streamlit/issues/7969)).
- 🌐 When you pass a CSS file's path to [`st.html`](https://docs.jeamlit.io/develop/api-reference/text/st.html), Streamlit will automatically insert `<style>` tags and avoid creating extra space in the app ([#10979](https://github.com/streamlit/streamlit/pull/10979), [#9388](https://github.com/streamlit/streamlit/issues/9388), [#10027](https://github.com/streamlit/streamlit/issues/10027)).
- 😃 You can add an icon to the left of the value in [`st.text_input`](https://docs.jeamlit.io/develop/api-reference/widgets/st.text_input) and [`st.number_input`](https://docs.jeamlit.io/develop/api-reference/widgets/st.number_input).
